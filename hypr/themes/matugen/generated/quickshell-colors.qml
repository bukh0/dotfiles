...
QtObject {
    readonly property color primary:              "#8bd0f0"
    readonly property color primaryFg:            "#003546"
    readonly property color secondary:            "#b4cad6"
    readonly property color secondaryFg:          "#1f333d"
    readonly property color tertiary:             "#c6c2ea"
    readonly property color tertiaryFg:           "#2f2d4c"
    readonly property color surface:              "#0f1417"
    readonly property color surfaceFg:            "#dfe3e7"
